...
-- elements["ARC-CH2-IN-PTR"]				= multiposition_switch(		_("ARC-15 Right Frequency"),			devices.ARC_15_PANEL_P,	arc15_commands.PRIMARY_1KHz,	466,	20,	1/20)
	...
	axisCommands = {
		{cockpit_device_id = devices.PKP72M_P, action = pkp72m_commands.PitchTrimKnob, name = _('Pitch Trim Knob PKP72M')},
		{cockpit_device_id = devices.UKT_2, action = ukt2_commands.PitchTrimKnob_AXIS, name = _('Pitch Trim Knob UKT2')},

		{cockpit_device_id = devices.ELEC_INTERFACE, action = elec_commands.DCGangSwitcher, name = _('DC Voltmeter Knob')},
		{cockpit_device_id = devices.ELEC_INTERFACE, action = elec_commands.ACGangSwitcher, name = _('AC Voltmeter Knob')},
		{cockpit_device_id = devices.FUELSYS_INTERFACE, action = fuel_commands.FuelMeter, name = _('Fuel Meter Tank')},
		{cockpit_device_id = devices.ANTI_ICE_INTERFACE, action = AntiIceSys_commands.ANTIICE_Ammeter, name = _('AC Ammeter Knob')},

		{cockpit_device_id = devices.SPUU_52, action = spuu_commands.control_AXIS, name = _('SPUU Adjustment Knob')},

		{cockpit_device_id = devices.WEAP_SYS, action = weapon_commands.Pilot_RELOAD_LEFT, name = _('Reload Left Gondola')},
		{cockpit_device_id = devices.WEAP_SYS, action = weapon_commands.Pilot_RELOAD_RIGHT, name = _('Reload Right Gondola')},
		{cockpit_device_id = devices.WEAP_SYS, action = weapon_commands.Pilot_SWITCHER_OFF_GM_URS_NPU, name = _('Select Weapon')},

		{cockpit_device_id = devices.ASP_17V, action = asp_commands.Elevation_Delta_AXIS, name = _('Sight Crosshair Vertical Adjustment')},
		{cockpit_device_id = devices.ASP_17V, action = asp_commands.Base_Range_AXIS, name = _('Sight Base and Range Adjustment')},
		{cockpit_device_id = devices.ASP_17V, action = asp_commands.Brightness_PM_AXIS, name = _('Sight Crosshair Brightness Adjustment')},
		{cockpit_device_id = devices.ASP_17V, action = asp_commands.Azimuth_Delta_AXIS, name = _('Sight Crosshair Horizontal Adjustment')},
		{cockpit_device_id = devices.ASP_17V, action = asp_commands.Brightness_NS_AXIS, name = _('Sight Grid Brightness Adjustment')},
		{cockpit_device_id = devices.ASP_17V, action = asp_commands.Range_Value_AXIS, name = _('Sight Range Adjustment')},

		{cockpit_device_id = devices.DISS_15, action = diss_commands.CHECK_SWITCH, name = _('DISS Select Mode')},

		{cockpit_device_id = devices.ARC_15_PANEL_P, action = arc15_commands.VOLUME, name = _('ARC-15 Volume')},

		{cockpit_device_id = devices.R_863, action = r863_commands.VOLUME_AXIS, name = _('R-863 Volume')},
		{cockpit_device_id = devices.R_863, action = r863_commands.CHANNEL_SEL, name = _('R-863 Channel Select')},

		{cockpit_device_id = devices.JADRO_1I, action = jadro_commands.VOLUME_AXIS, name = _('Jadro-1I Volume')},
		{cockpit_device_id = devices.JADRO_1I, action = jadro_commands.SQUELCH_AXIS, name = _('Jadro-1I Squelch')},

		{cockpit_device_id = devices.EUCALYPT_M24, action = eucalypt_commands.VOLUME_CHANGE_AXIS, name = _('Eucalypt-M24 Volume')},
		{cockpit_device_id = devices.EUCALYPT_M24, action = eucalypt_commands.CHANNEL_CHANGE, name = _('Eucalypt-M24 Channel Select')},

		{cockpit_device_id = devices.R_852, action = r852_commands.VOLUME_AXIS, name = _('R-852 Volume')},
		{cockpit_device_id = devices.R_852, action = r852_commands.CHANNEL, name = _('R-852 Channel Select')},

		{cockpit_device_id = devices.SPU_8, action = SPU_8_Mi24_commands.CMD_SPU8_P_RADIO_VOLUME, name = _('SPU-8 Listening Volume')},
		{cockpit_device_id = devices.SPU_8, action = SPU_8_Mi24_commands.CMD_SPU8_P_MODE, name = _('SPU-8 Radio Source Selector Switch')},
		{cockpit_device_id = devices.SPU_8, action = SPU_8_Mi24_commands.CMD_SPU8_P_MAIN_VOLUME, name = _('SPU-8 Main Volume')},

		{cockpit_device_id = devices.IFF, action = IFF_6201_commands.CMD_IFF_Mode_Sw, name = _('IFF Transponder Mode Selector Switch')},
		{cockpit_device_id = devices.Recorder_MC61, action = RecorderMC61_commands.CMD_LightRst, name = _('Recorder MC 61 Brightness Knob')},
	}
}