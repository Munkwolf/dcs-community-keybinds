...
-- elements["ARC-OP-CH1-IN-PTR"]			= multiposition_switch(		_("ARC-15 Right Frequency"),			devices.ARC_15_PANEL_O,	arc15_commands.PRIMARY_1KHz,	644,	20,	1/20, nil, nil, nil, nil, 1)
	...
	axisCommands = {
		{cockpit_device_id = devices.PKP72M_O, action = pkp72m_commands.PitchTrimKnob, name = _('Pitch Trim Knob PKP72M')},

		{cockpit_device_id = devices.WEAP_SYS, action = weapon_commands.Operator_SWITCHER_WEAP_TYPE_AB, name = _('Select Weapon')},
		{cockpit_device_id = devices.WEAP_SYS, action = weapon_commands.Operator_SWITCHER_LAUNCH_STATION, name = _('Select Station')},
		{cockpit_device_id = devices.I9K113, action = i9K113_commands.Command_VHOD_BVK_KV, name = _('BVK Set')},
		{cockpit_device_id = devices.PKV, action = pki_commands.Brightness, name = _('PKI Brightness Adjustment')},

		{cockpit_device_id = devices.ASO_2V, action = avASO_2V_commands.ASO_2V_Set_I_II_III, name = _('Countermeasures Set I/II/III')},

		{cockpit_device_id = devices.ARC_15_PANEL_O, action = arc15_commands.VOLUME, name = _('ARC-15 Volume')},

		{cockpit_device_id = devices.SPU_8, action = SPU_8_Mi24_commands.CMD_SPU8_O_RADIO_VOLUME, name = _('SPU-8 Listening Volume')},
		{cockpit_device_id = devices.SPU_8, action = SPU_8_Mi24_commands.CMD_SPU8_O_MODE, name = _('SPU-8 Radio Source Selector Switch')},
		{cockpit_device_id = devices.SPU_8, action = SPU_8_Mi24_commands.CMD_SPU8_O_MAIN_VOLUME, name = _('SPU-8 Main Volume')},
	}
}