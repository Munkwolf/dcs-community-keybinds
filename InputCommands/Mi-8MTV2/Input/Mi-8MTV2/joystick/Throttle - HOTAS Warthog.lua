return {
	...
	axisCommands = {
		{cockpit_device_id = devices.ELEC_INTERFACE, action = device_commands.Button_10, name = _('Standby Generator Voltage Adjustment Rheostat')},
		{cockpit_device_id = devices.ELEC_INTERFACE, action = device_commands.Button_11, name = _('Generator 1 Voltage Adjustment Rheostat')},
		{cockpit_device_id = devices.ELEC_INTERFACE, action = device_commands.Button_18, name = _('Generator 2 Voltage Adjustment Rheostat')},

		{cockpit_device_id = devices.WEAPON_SYS, action = device_commands.Button_43, name = _('Burst Length Knob')},

		{cockpit_device_id = devices.GMK1A, action = device_commands.Button_6, name = _('GMC Latitude Selection Knob')},

		{cockpit_device_id = devices.LIGHT_SYSTEM, action = device_commands.Button_5, name = _('Left Red Lights Brightness Group 1 Rheostat')},
		{cockpit_device_id = devices.LIGHT_SYSTEM, action = device_commands.Button_6, name = _('Left Red Lights Brightness Group 2 Rheostat')},
		{cockpit_device_id = devices.LIGHT_SYSTEM, action = device_commands.Button_7, name = _('Right Red Lights Brightness Group 1 Rheostat')},
		{cockpit_device_id = devices.LIGHT_SYSTEM, action = device_commands.Button_8, name = _('Right Red Lights Brightness Group 2 Rheostat')},
		{cockpit_device_id = devices.LIGHT_SYSTEM, action = device_commands.Button_9, name = _('Central Red Lights Brightness Group 1 Rheostat')},
		{cockpit_device_id = devices.LIGHT_SYSTEM, action = device_commands.Button_10, name = _('Central Red Lights Brightness Group 2 Rheostat')},
		{cockpit_device_id = devices.LIGHT_SYSTEM, action = device_commands.Button_11, name = _('5.5V Lights Brightness Rheostat')},

		{cockpit_device_id = devices.SPU_7, action = device_commands.Button_1, name = _('Common Volume Knob')},
		{cockpit_device_id = devices.SPU_7, action = device_commands.Button_2, name = _('Listening Volume Knob')},

		{cockpit_device_id = devices.R_863, action = device_commands.Button_5, name = _('R-863, Volume Knob')},
		{cockpit_device_id = devices.R_828, action = device_commands.Button_2, name = _('R-828, Volume Knob')},
		{cockpit_device_id = devices.JADRO_1A, action = device_commands.Button_7, name = _('Jadro 1A, Volume Knob')},
		{cockpit_device_id = devices.ARC_UD, action = device_commands.Button_5, name = _('ARC-UD, Volume Knob')},

		{cockpit_device_id = devices.PKV, action = device_commands.Button_1, name = _('Sight Brightness Knob')},
		{cockpit_device_id = devices.PKV, action = device_commands.Button_3, name = _('Sight Limb Knob')},

		{cockpit_device_id = devices.ARC_9, action = device_commands.Button_1, name = _('ARC-9, Volume Knob')},
		{cockpit_device_id = devices.ARC_9, action = device_commands.Button_4, name = _('ARC-9, Backup Frequency Tune Knob')},
		{cockpit_device_id = devices.ARC_9, action = device_commands.Button_7, name = _('ARC-9, Main Frequency Tune Knob')},
		{cockpit_device_id = devices.HEATER_KO50, action = device_commands.Button_5, name = _('KO-50 Target Temperature Knob')},

		{cockpit_device_id = devices.RECORDER_P503B, action = device_commands.Button_2, name = _('Recorder P-503B Backlight Brightness Knob')},
	}
}