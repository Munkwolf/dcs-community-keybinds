return {
	keyCommands = {
		...
		{cockpit_device_id = devices.CONTROL_INTERFACE, down = control_commands.F86_CockpitDeviceCommand_FlapsHandle, value_down = -1, name = _('Flaps Handle - DOWN'), category = {_('Systems'), _('Custom')}},
		{cockpit_device_id = devices.CONTROL_INTERFACE, down = control_commands.F86_CockpitDeviceCommand_FlapsHandle, value_down = 1, name = _('Flaps Handle - UP'), category = {_('Systems'), _('Custom')}},
