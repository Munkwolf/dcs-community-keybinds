return {
	keyCommands = {
		...
		{cockpit_device_id = devices.WINGSWEEP, down = device_commands.WINGSWEEP_EmergencySweepCover, value_down = 0, name = _('Emergency Wing Sweep Handle Cover - CLOSE'), category = {_('Throttle'), _('Custom')}},
		{cockpit_device_id = devices.WINGSWEEP, down = device_commands.WINGSWEEP_EmergencySweepCover, value_down = 1, name = _('Emergency Wing Sweep Handle Cover - OPEN'), category = {_('Throttle'), _('Custom')}},
		...
		{cockpit_device_id = devices.WINGSWEEP, down = device_commands.WINGSWEEP_EmergencySweepCover, up = device_commands.WINGSWEEP_EmergencySweepCover, value_down = 1, value_up = 0, name = _('Emergency Wing Sweep Handle Cover - OPEN else CLOSE (2-way Switch)'), category = {_('Throttle'), _('Custom')}},

		{cockpit_device_id = devices.WINGSWEEP, down = device_commands.WINGSWEEP_EmergencyLeverExtended, value_down = 0, name=_('Emergency Wing Sweep Handle - DEFAULT'), category = {_('Throttle'), _('Custom')}},
		{cockpit_device_id = devices.WINGSWEEP, down = device_commands.WINGSWEEP_EmergencyLeverExtended, value_down = 1, name=_('Emergency Wing Sweep Handle - PULL'), category = {_('Throttle'), _('Custom')}},
		{cockpit_device_id = devices.WINGSWEEP, down = device_commands.WINGSWEEP_EmergencyLeverExtended, up = device_commands.WINGSWEEP_EmergencyLeverExtended, value_down = 0, value_up = 1, name=_('Emergency Wing Sweep Handle - DEFAULT else PULL (2-way Switch)'), category = {_('Throttle'), _('Custom')}},
		{cockpit_device_id = devices.WINGSWEEP, down = device_commands.WINGSWEEP_EmergencyLeverExtended, up = device_commands.WINGSWEEP_EmergencyLeverExtended, value_down = 1, value_up = 0, name=_('Emergency Wing Sweep Handle - PULL else DEFAULT (2-way Switch)'), category = {_('Throttle'), _('Custom')}},
		...
		{cockpit_device_id = devices.MACHANDAIRSPEED, pressed = device_commands.AIRSPEED_Knob, value_pressed = -0.01, name=_('Airspeed Indicator Knob - DECREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, pressed = device_commands.AIRSPEED_Knob, value_pressed = 0.01, name=_('Airspeed Indicator Knob - INCREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, pressed = device_commands.AIRSPEED_Knob, value_pressed = -0.02, name=_('Airspeed Indicator Knob - DECREASE'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, pressed = device_commands.AIRSPEED_Knob, value_pressed = 0.02, name=_('Airspeed Indicator Knob - INCREASE'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, pressed = device_commands.AIRSPEED_Knob, value_pressed = -0.04, name=_('Airspeed Indicator Knob - DECREASE (Fast)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, pressed = device_commands.AIRSPEED_Knob, value_pressed = 0.04, name=_('Airspeed Indicator Knob - INCREASE (Fast)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, down = device_commands.AIRSPEED_KnobSwitch, value_down = 0, name = _('Airspeed Indicator Knob - PULL'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, down = device_commands.AIRSPEED_KnobSwitch, value_down = 1, name = _('Airspeed Indicator Knob - PUSH'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, down = device_commands.AIRSPEED_KnobSwitch, up = device_commands.AIRSPEED_KnobSwitch, value_down = 0, value_up = 1, name = _('Airspeed Indicator Knob - PULL else PUSH (2-way Switch)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.MACHANDAIRSPEED, down = device_commands.AIRSPEED_KnobSwitch, up = device_commands.AIRSPEED_KnobSwitch, value_down = 1, value_up = 0, name = _('Airspeed Indicator Knob - PUSH else PULL (2-way Switch)'), category = {_('Instrument Panel'), _('Custom')}},
...
--		{cockpit_device_id = devices.AFCS, down = device_commands.AP_Heading_toggle_offgt, value_down = 1, name = _('Autopilot Heading Toggle GT'), category = {_('AFCS Control Panel'), _('Custom')}},
		...
		{cockpit_device_id = devices.FUELSYSTEM, pressed = device_commands.FUELSYSTEM_Bingo_Knob, value_pressed = -0.05,  name=_('Bingo Fuel Knob - DECREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.FUELSYSTEM, pressed = device_commands.FUELSYSTEM_Bingo_Knob, value_pressed = 0.05, name=_('Bingo Fuel Knob - INCREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.FUELSYSTEM, pressed = device_commands.FUELSYSTEM_Bingo_Knob, value_pressed = -0.1,  name=_('Bingo Fuel Knob - DECREASE'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.FUELSYSTEM, pressed = device_commands.FUELSYSTEM_Bingo_Knob, value_pressed = 0.1, name=_('Bingo Fuel Knob - INCREASE'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.FUELSYSTEM, pressed = device_commands.FUELSYSTEM_Bingo_Knob, value_pressed = -0.2,  name=_('Bingo Fuel Knob - DECREASE (Fast)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.FUELSYSTEM, pressed = device_commands.FUELSYSTEM_Bingo_Knob, value_pressed = 0.2, name=_('Bingo Fuel Knob - INCREASE (Fast)'), category = {_('Instrument Panel'), _('Custom')}},
		...
		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Knob_Brightness, value_down = 0.0, name = _('HSD Brightness - 0%'), category = {_('HSD'), _('Custom')}},
		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Knob_Brightness, value_down = 0.25, name = _('HSD Brightness - 25%'), category = {_('HSD'), _('Custom')}},
		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Knob_Brightness, value_down = 0.33, name = _('HSD Brightness - 33%'), category = {_('HSD'), _('Custom')}},
		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Knob_Brightness, value_down = 0.5, name = _('HSD Brightness - 50%'), category = {_('HSD'), _('Custom')}},
		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Knob_Brightness, value_down = 0.66, name = _('HSD Brightness - 66%'), category = {_('HSD'), _('Custom')}},
		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Knob_Brightness, value_down = 0.75, name = _('HSD Brightness - 75%'), category = {_('HSD'), _('Custom')}},
		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Knob_Brightness, value_down = 1.0, name = _('HSD Brightness - 100%'), category = {_('HSD'), _('Custom')}},

		{cockpit_device_id = devices.HSD, down = device_commands.HSD_Btn_Test, up = device_commands.HSD_Btn_Test, value_down = 1, value_up = 0, name = _('HSD Test'), category = {_('HSD'), _('Custom')}},
		...
		{cockpit_device_id = devices.STDBYAI, pressed = device_commands.STDBYADI_trim, value_pressed = -0.01,  name = _('Standby ADI Knob - DECREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.STDBYAI, pressed = device_commands.STDBYADI_trim, value_pressed = 0.01, name = _('Standby ADI Knob - INCREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.STDBYAI, pressed = device_commands.STDBYADI_trim, value_pressed = -0.02,  name = _('Standby ADI Knob - DECREASE'), category = {_('Instrument Panel'), _('Custom')}},
		...
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_VDI_handle, value_down = 0, name = _('HUD Filter - OFF'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_VDI_handle, value_down = 1, name = _('HUD Filter - ON'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_VDI_handle, up = device_commands.VDIG_VDI_handle, value_down = 0, value_up = 1, name = _('HUD Filter - OFF else ON (2-way Switch)'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_VDI_handle, up = device_commands.VDIG_VDI_handle, value_down = 1, value_up = 0, name = _('HUD Filter - ON else OFF (2-way Switch)'), category = {_('VDI'), _('Custom')}},

		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_HUD_trim, value_down = 0.0, name = _('HUD Trim - 0%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_HUD_trim, value_down = 0.25, name = _('HUD Trim - 25%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_HUD_trim, value_down = 0.33, name = _('HUD Trim - 33%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_HUD_trim, value_down = 0.5, name = _('HUD Trim - 50%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_HUD_trim, value_down = 0.66, name = _('HUD Trim - 66%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_HUD_trim, value_down = 0.75, name = _('HUD Trim - 75%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.HUD, down = device_commands.VDIG_HUD_trim, value_down = 1.0, name = _('HUD Trim - 100%'), category = {_('VDI'), _('Custom')}},

		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_trim, value_down = 0.0, name = _('VSDI Screen Trim - 0%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_trim, value_down = 0.25, name = _('VSDI Screen Trim - 25%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_trim, value_down = 0.33, name = _('VSDI Screen Trim - 33%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_trim, value_down = 0.5, name = _('VSDI Screen Trim - 50%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_trim, value_down = 0.66, name = _('VSDI Screen Trim - 66%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_trim, value_down = 0.75, name = _('VSDI Screen Trim - 75%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_trim, value_down = 1.0, name = _('VSDI Screen Trim - 100%'), category = {_('VDI'), _('Custom')}},

		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VDI_contrast, value_down = 0.0, name = _('VDI Screen Contrast - 0%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VDI_contrast, value_down = 0.25, name = _('VDI Screen Contrast - 25%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VDI_contrast, value_down = 0.33, name = _('VDI Screen Contrast - 33%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VDI_contrast, value_down = 0.5, name = _('VDI Screen Contrast - 50%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VDI_contrast, value_down = 0.66, name = _('VDI Screen Contrast - 66%'), category = {_('VDI'), _('Custom')}},
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VDI_contrast, value_down = 0.75, name = _('VDI Screen Contrast - 75%'), category = {_('VDI'), _('Custom')}},
		...
		{cockpit_device_id = devices.VDI, down = device_commands.VDIG_VSDI_bright, value_down = 0.66, name = _('VDI Screen Brightness - 66%'), category = {_('VDI'), _('Custom')}},
		...
		{cockpit_device_id = devices.CLOCK, pressed = device_commands.CLOCK_Wind, value_pressed = -0.15,  name = _('Clock Wind - DECREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CLOCK, pressed = device_commands.CLOCK_Wind, value_pressed = 0.15, name = _('Clock Wind - INCREASE (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CLOCK, pressed = device_commands.CLOCK_Wind, value_pressed = -0.3,  name = _('Clock Wind - DECREASE'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CLOCK, pressed = device_commands.CLOCK_Wind, value_pressed = 0.3, name = _('Clock Wind - INCREASE'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CLOCK, pressed = device_commands.CLOCK_Wind, value_pressed = -0.6,  name = _('Clock Wind - DECREASE (Fast)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CLOCK, pressed = device_commands.CLOCK_Wind, value_pressed = 0.6, name = _('Clock Wind - INCREASE (Fast)'), category = {_('Instrument Panel'), _('Custom')}},

		{cockpit_device_id = devices.CLOCK, down = device_commands.CLOCK_Timer, up = device_commands.CLOCK_Timer, value_down = 1, value_up = 0, name = _('Clock Push'), category = {_('Instrument Panel'), _('Custom')}},
	},
	axisCommands = {
		{cockpit_device_id = devices.WINGSWEEP, action = device_commands.WINGSWEEP_EmergencySweepLever, name = _('Emergency Wing Sweep Lever')},
		{cockpit_device_id = devices.HSD, action = device_commands.HSD_Knob_Brightness, name = _('HSD Brightness')},
		{cockpit_device_id = devices.ECMD, action = device_commands.ECMD_Knob_Brightness, name = _('ECMD Brightness')},
		{cockpit_device_id = devices.TACAN, action = device_commands.TACAN_Knob_Vol_Pilot, name = _('TACAN Volume')},
		{cockpit_device_id = devices.ICS, action = device_commands.RADIO_ICS_Vol_ALR67_Pilot, name = _('ALR-67 Volume')},
		{cockpit_device_id = devices.ICS, action = device_commands.RADIO_ICS_Vol_Sidewinder, name = _('Sidewinder Volume')},
		{cockpit_device_id = devices.ICS, action = device_commands.RADIO_ICS_Vol_Pilot, name = _('ICS Volume')},
		{cockpit_device_id = devices.ARC159, action = device_commands.RADIO_UHF_VOL_Pilot, name = _('UHF ARC-159 Volume')},
		{cockpit_device_id = devices.ARC159, action = device_commands.RADIO_UHF_BRT_Pilot, name = _('UHF ARC-159 Display Brightness')},
		{cockpit_device_id = devices.ARC182, action = device_commands.RADIO_VHF_VOL_PILOT, name = _('VHF/UHF ARC-182 Volume')},
		{cockpit_device_id = devices.ARC159, action = device_commands.RADIO_UHF_Remote_DISP_BRT_Pilot, name = _('UHF Radio Remote Display Brightness')},
		{cockpit_device_id = devices.ARC182, action = device_commands.RADIO_VHF_Remote_DISP_BRT_Pilot, name = _('VHF/UHF Radio Remote Display Brightness')},
		{cockpit_device_id = devices.AHRS, action = device_commands.AHRS_LatCorrection, name = _('Compass LAT Correction')},
		{cockpit_device_id = devices.HUD, action = device_commands.DISP_HUD_pitch_bright, name = _('HUD Pitch Ladder Brightness')},
		{cockpit_device_id = devices.HUD, action = device_commands.VDIG_HUD_trim, name = _('HUD Trim')},
		{cockpit_device_id = devices.VDI, action = device_commands.VDIG_VSDI_trim, name = _('VSDI Screen Trim')},
		{cockpit_device_id = devices.VDI, action = device_commands.VDIG_VDI_contrast, name = _('VDI Screen Contrast')},
		{cockpit_device_id = devices.VDI, action = device_commands.VDIG_VSDI_bright, name = _('VSDI Screen Brightness')},
		{cockpit_device_id = devices.HUD, action = device_commands.VDIG_HUD_bright, name = _('HUD Brightness')},
		{cockpit_device_id = devices.COCKPITMECHANICS, action = device_commands.Temperature, name = _('Temperature')},
		{cockpit_device_id = devices.AOASYSTEM, action = device_commands.AoA_IndexerStrength, name = _('AoA Indexer Light Intensity')},
		{cockpit_device_id = devices.COCKPITMECHANICS, action = device_commands.LIGHTS_ACMPanel, name = _('ACM Panel Light Intensity')},
		{cockpit_device_id = devices.COCKPITMECHANICS, action = device_commands.LIGHTS_Instruments, name = _('Instrument Light Intensity')},
		{cockpit_device_id = devices.COCKPITMECHANICS, action = device_commands.LIGHTS_Console, name = _('Console Light Intensity')},
		{cockpit_device_id = devices.COCKPITMECHANICS, action = device_commands.LIGHTS_Formation, name = _('Formation Light Intensity')},
		{cockpit_device_id = devices.TACAN, action = device_commands.TACAN_Knob_Func_Pilot, name = _('TACAN Mode')},
		{cockpit_device_id = devices.TACAN, action = device_commands.TACAN_Knob_Chnl_Tens_Pilot, name = _('TACAN Channel Wheel (Tens)')},
		{cockpit_device_id = devices.TACAN, action = device_commands.TACAN_Knob_Chnl_Ones_Pilot, name = _('TACAN Channel Wheel (Ones)')},
		{cockpit_device_id = devices.ICS, action = device_commands.RADIO_ICS_Ampl_Pilot, name = _('ICS Amplifier Selector')},
		{cockpit_device_id = devices.ARC159, action = device_commands.RADIO_UHF_FREQ_MODE_Pilot, name = _('UHF ARC-159 Freq Mode')},
