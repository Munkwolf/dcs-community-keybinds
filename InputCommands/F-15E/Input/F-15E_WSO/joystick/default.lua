...
-- elements["PTN_1383"]	= default_axis_limited(_("Timer Stop"),								devices.FLINST,			fltinst_commands.rc_tmr_stop_btn,		1383, 0, 0.1)
	...
	axisCommands = {
		...
		{cockpit_device_id = devices.UFCCTRL_REAR, action = ufc_commands.UFC_VOL_R1, name = _('UHF Radio 1 Volume')},
		{cockpit_device_id = devices.UFCCTRL_REAR, action = ufc_commands.UFC_VOL_R2, name = _('UHF Radio 2 Volume')},
		{cockpit_device_id = devices.UFCCTRL_REAR, action = ufc_commands.UFC_VOL_R3, name = _('UHF Radio 3 Volume')},
		{cockpit_device_id = devices.UFCCTRL_REAR, action = ufc_commands.UFC_VOL_R4, name = _('UHF Radio 4 Volume')},
		{cockpit_device_id = devices.UFCCTRL_REAR, action = ufc_commands.UFC_BRT_CTRL, name = _('UFC LCD Brightness')},

		{cockpit_device_id = devices.CNPYSYST, action = cnp_commands.rear_em_cnpy_jett_lever, name = _('Emergency Canopy Jettison')},
		{cockpit_device_id = devices.LGS, action = ldg_commands.rc_em_gear_lever, name = _('Emergency Landing Gear Handle')},
		{cockpit_device_id = devices.LGS, action = misc_commands.em_bk_steer_lever_rear, name = _('Emergency Brake/Steering Handle')},

		{cockpit_device_id = devices.TGPCTRL, action = snsrctrl_commands.tpod_flir_gain_knob, name = _('TGP FLIR Gain')},
		{cockpit_device_id = devices.TGPCTRL, action = snsrctrl_commands.tpod_flir_level_knob, name = _('TGP FLIR Level')},

		{cockpit_device_id = devices.TEWS, action = volctrl_commands.rc_caution_vol, name = _('Caution Volume')},
		{cockpit_device_id = devices.TEWS, action = volctrl_commands.rc_launch_vol, name = _('Launch Volume')},
		{cockpit_device_id = devices.EWS_JMR, action = volctrl_commands.rc_ics_vol, name = _('ICS Volume')},
		{cockpit_device_id = devices.PACS, action = volctrl_commands.rc_wpn_vol, name = _('WPN Volume')},
		{cockpit_device_id = devices.ILS, action = volctrl_commands.rc_ils_vol, name = _('ILS Volume')},
		{cockpit_device_id = devices.TACAN, action = volctrl_commands.rc_tacan_vol, name = _('TACAN Volume')},

		{cockpit_device_id = devices.INTLT, action = intlt_commands.rc_console_lt_knob, name = _('Console Lights')},
		{cockpit_device_id = devices.INTLT, action = intlt_commands.rc_inst_pnl_lt_knob, name = _('Instruments Panel Lights')},
		{cockpit_device_id = devices.INTLT, action = intlt_commands.rc_ufc_bcklt_br_knob, name = _('UFC Panel Backlights')},
		{cockpit_device_id = devices.INTLT, action = intlt_commands.rc_chart_lt_knob, name = _('Chart Panel Lights')},
		{cockpit_device_id = devices.INTLT, action = intlt_commands.rc_wac_bklt_knob, name = _('Warning/Caution Lights')},
		{cockpit_device_id = devices.INTLT, action = intlt_commands.rc_flood_lt_knob, name = _('Storm Flood Lights')},
		{cockpit_device_id = devices.INTLT, action = intlt_commands.rc_chart_lt_lamp, name = _('Chart Spot Lamp Position')},
	}
}