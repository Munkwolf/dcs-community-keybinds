return {
	...
	axisCommands = {
		{cockpit_device_id = devices.FUSEBOX, action = device_commands.Button_68, name = _('Magnetos')},
		{cockpit_device_id = devices.CONTROLS, action = device_commands.Button_25, name = _('Cockpit.Bf109K4.fuel_pumps_quad')},
		{cockpit_device_id = devices.CONTROLS, action = device_commands.Button_37, name = _('Radiators')},
		{cockpit_device_id = devices.VHF_RADIO, action = device_commands.Button_2, name = _('FuG16ZY Preset')},
		{cockpit_device_id = devices.CONTROLS, action = device_commands.Button_12, name = _('Input.Bf109K4.primer')},
		{cockpit_device_id = devices.CONTROLS, action = device_commands.Button_41, name = _('Input.Bf109K4.fuel_jettison')},
		{cockpit_device_id = devices.ENGINE_CONTROLS, action = device_commands.Button_6, name = _('Cockpit.Bf109K4.schnellstop')},
		{cockpit_device_id = devices.WEAPONS_CONTROLS, action = device_commands.Button_13, name = _('Cockpit.Bf109K4.cb_r101')},
		{cockpit_device_id = devices.CONTROLS, action = device_commands.Button_4, name = _('Cockpit.Bf109K4.uc_emergency')},
		{cockpit_device_id = devices.CONTROLS, action = device_commands.Button_32, name = _('Cockpit.Bf109K4.canopy_jettison')},
		{cockpit_device_id = devices.CONTROLS, action = device_commands.Button_29, name = _('Cockpit.Bf109K4.canopy_operate')},
		{cockpit_device_id = devices.WEAPONS_CONTROLS, action = device_commands.Button_18, name = _('Cockpit.Bf109K4.notwurf')},
		{cockpit_device_id = devices.OXYGEN, action = device_commands.Button_1, name = _('Cockpit.Bf109K4.oxygen_valve')},
	}
}