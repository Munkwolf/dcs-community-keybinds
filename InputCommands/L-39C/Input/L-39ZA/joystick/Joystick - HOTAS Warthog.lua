return {
	keyCommands = {
		...
		{down = iCommandEngineLaunchMethod, up = iCommandEngineLaunchMethod, value_down = 0, value_up = -1, name = _('Engine Launch Method Switch - STARTING else PRESERV (2-way Switch)'), category = {_('Engine'), _('Left Console'), _('Only Front Cockpit'), _('Custom')}},
		{down = iCommandEngineLaunchMethod, up = iCommandEngineLaunchMethod, value_down = 1, value_up = -1, name = _('Engine Launch Method Switch - COLD ROTATION else PRESERV (2-way Switch)'), category = {_('Engine'), _('Left Console'), _('Only Front Cockpit'), _('Custom')}},
		...
		{cockpit_device_id = devices.ELEC_INTERFACE, down = electric_commands.L39C_Command_CB_HeatingSensorAOA_EXT, up = electric_commands.L39C_Command_CB_HeatingSensorAOA_EXT, value_down = 0, value_up = 1, name = _('CB Heating DUA-3 Switch - OFF else ON (2-way Switch)'), category = {_('Main CB Switch Panel'), _('Only Front Cockpit'), _('Custom')}},
		{cockpit_device_id = devices.ELEC_INTERFACE, down = electric_commands.L39C_Command_CB_HeatingSensorAOA_EXT, up = electric_commands.L39C_Command_CB_HeatingSensorAOA_EXT, value_down = 1, value_up = 0, name = _('CB Heating DUA-3 Switch - ON else OFF (2-way Switch)'), category = {_('Main CB Switch Panel'), _('Only Front Cockpit'), _('Custom')}},
		...
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_29, up = device_commands.Button_29, value_down = 0, value_up = 1, name = _('CB UB-16 Missile Firing Control Circuit Power Switch - OFF else ON (2-way Switch)'), category = {_('Armament Control Panel'), _('Custom')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_29, up = device_commands.Button_29, value_down = 1, value_up = 0, name = _('CB UB-16 Missile Firing Control Circuit Power Switch - ON else OFF (2-way Switch)'), category = {_('Armament Control Panel'), _('Custom')}},
		...
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_34, up = device_commands.Button_34, value_down = -1, value_up = 1, name = _('Missile/Bomb Release Selector Switch - STARB-BOTH else PORT (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_34, up = device_commands.Button_34, value_down = 1, value_up = -1, name = _('Missile/Bomb Release Selector Switch - PORT else STARB-BOTH (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_68, up = device_commands.Button_68, value_down = 0, value_up = 1, name = _('Gun+PK3 Switch Cover - CLOSE else OPEN (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_68, up = device_commands.Button_68, value_down = 1, value_up = 0, name = _('Gun+PK3 Switch Cover - OPEN else CLOSE (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_69, up = device_commands.Button_69, value_down = 0, value_up = 1, name = _('Gun+PK3 Switch - OFF else ON (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_69, up = device_commands.Button_69, value_down = 1, value_up = 0, name = _('Gun+PK3 Switch - ON else OFF (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_64, up = device_commands.Button_64, value_down = 0, value_up = 1, name = _('Emergency Jettison Inboard Stations Switch Cover - CLOSE else OPEN (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_64, up = device_commands.Button_64, value_down = 1, value_up = 0, name = _('Emergency Jettison Inboard Stations Switch Cover - OPEN else CLOSE (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_65, up = device_commands.Button_65, value_down = 0, value_up = 1, name = _('Emergency Jettison Inboard Stations Switch - OFF else ON (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_65, up = device_commands.Button_65, value_down = 1, value_up = 0, name = _('Emergency Jettison Inboard Stations Switch - ON else OFF (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_73, up = device_commands.Button_73, value_down = 0, value_up = 0.5, name = _('Pyro Charge Selector Switch - I else II (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_73, up = device_commands.Button_73, value_down = 1, value_up = 0.5, name = _('Pyro Charge Selector Switch - III else II (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_60, up = device_commands.Button_60, value_down = 0, value_up = 1, name = _('Arm/Safe Cannon Gsh-23 Switch - SAFE else ARM (2-way Switch)'), category = {_('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_60, up = device_commands.Button_60, value_down = 1, value_up = 0, name = _('Arm/Safe Cannon Gsh-23 Switch - ARM else SAFE (2-way Switch)'), category = {_('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_70, up = device_commands.Button_70, value_down = 0, value_up = 1, name = _('Charge Outer Guns Switch - OFF else ON (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_70, up = device_commands.Button_70, value_down = 1, value_up = 0, name = _('Charge Outer Guns Switch - ON else OFF (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_71, up = device_commands.Button_71, value_down = 0, value_up = 1, name = _('Charge Inner Guns Switch - OFF else ON (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_71, up = device_commands.Button_71, value_down = 1, value_up = 0, name = _('Charge Inner Guns Switch - ON else OFF (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_66, up = device_commands.Button_66, value_down = 0, value_up = 1, name = _('Emergency Launch Missiles Button Cover - CLOSE else OPEN (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_66, up = device_commands.Button_66, value_down = 1, value_up = 0, name = _('Emergency Launch Missiles Button Cover - OPEN else CLOSE (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_62, up = device_commands.Button_62, value_down = 0, value_up = 1, name = _('CB Arm Outer Guns Power Switch - OFF else ON (2-way Switch)'), category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_62, up = device_commands.Button_62, value_down = 1, value_up = 0, name = _('CB Arm Outer Guns Power Switch - ON else OFF (2-way Switch)'), category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_63, up = device_commands.Button_63, value_down = 0, value_up = 1, name = _('CB Arm Inner Guns Power Switch - OFF else ON (2-way Switch)'), category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_63, up = device_commands.Button_63, value_down = 1, value_up = 0, name = _('CB Arm Inner Guns Power Switch - ON else OFF (2-way Switch)'), category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_61, up = device_commands.Button_61, value_down = 0, value_up = 1, name = _('CB Arm Bombs Power Switch - OFF else ON (2-way Switch)'), category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_61, up = device_commands.Button_61, value_down = 1, value_up = 0, name = _('CB Arm Bombs Power Switch - ON else OFF (2-way Switch)'), category = {_('Center Pedestal'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_75, up = device_commands.Button_75, value_down = -1, value_up = 0, name = _('Bomb Series Selector Switch - SALVO else I (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_75, up = device_commands.Button_75, value_down = 1, value_up = 0, name = _('Bomb Series Selector Switch - TRAIN else I (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		...
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_37, up = device_commands.Button_37, value_down = 0, value_up = 1, name = _('Emergency Jettison Outboard Stations Switch Cover - CLOSE else OPEN (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_37, up = device_commands.Button_37, value_down = 1, value_up = 0, name = _('Emergency Jettison Outboard Stations Switch Cover - OPEN else CLOSE (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_38, up = device_commands.Button_38, value_down = 0, value_up = 1, name = _('Emergency Jettison Outboard Stations Switch - OFF else ON (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_38, up = device_commands.Button_38, value_down = 1, value_up = 0, name = _('Emergency Jettison Outboard Stations Switch - ON else OFF (2-way Switch)'), category = {_('Left Front Panel'), _('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = electric_commands.L39C_Command_CB_Weapon_EXT, up = electric_commands.L39C_Command_CB_Weapon_EXT, value_down = 0, value_up = 1, name = _('CB Weapon Switch - OFF else ON (2-way Switch)'), category = {_('Main CB Switch Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
		{cockpit_device_id = devices.WEAPON_SYSTEM, down = electric_commands.L39C_Command_CB_Weapon_EXT, up = electric_commands.L39C_Command_CB_Weapon_EXT, value_down = 1, value_up = 0, name = _('CB Weapon Switch - ON else OFF (2-way Switch)'), category = {_('Main CB Switch Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},

		{cockpit_device_id = devices.WEAPON_SYSTEM, down = device_commands.Button_77, up = device_commands.Button_77, value_down = 1, value_up = 0, name = _('Deblock Guns'), category = {_('Armament Control Panel'), _('Only Front Cockpit'), _('Custom, Front Cockpit')}},
	...
	axisCommands = {
		{cockpit_device_id = devices.ASP_3NM, action = device_commands.Button_12, name = _('ASP-3NMU Gunsight Color Filter (Custom)')},
		{cockpit_device_id = devices.ASP_3NM, action = device_commands.Button_11, name = _('ASP-3NMU Gunsight Fixed Reticle Mask Lever (Custom)')},

		{cockpit_device_id = devices.KPP_1273K, action = device_commands.Button_3, name = _('Artificial Horizon Zero Pitch Trim Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.KPP_1273K_INSTRUCTOR, action = device_commands.Button_3, name = _('Artificial Horizon Zero Pitch Trim Knob (Custom, Rear Cockpit)')},

		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_VOLUME_Fwd, name = _('RKL-41 ADF Volume Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_BRIGHTNESS_Fwd, name = _('RKL-41 ADF Brightness Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_DPRS_TUNE_Fwd, name = _('RKL-41 ADF Outer Beacon Frequency Tune Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_BPRS_TUNE_Fwd, name = _('RKL-41 ADF Inner Beacon Frequency Tune Knob (Custom, Front Cockpit)')},

		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_VOLUME_Aft, name = _('RKL-41 ADF Volume Knob (Custom, Rear Cockpit)')},
		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_BRIGHTNESS_Aft, name = _('RKL-41 ADF Brightness Knob (Custom, Rear Cockpit)')},
		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_DPRS_TUNE_Aft, name = _('RKL-41 ADF Outer Beacon Frequency Tune Knob (Custom, Rear Cockpit)')},
		{cockpit_device_id = devices.RKL_41, action = RKL_commands.CMD_RKL_41_BPRS_TUNE_Aft, name = _('RKL-41 ADF Inner Beacon Frequency Tune Knob (Custom, Rear Cockpit)')},

		{cockpit_device_id = devices.LIGHTS, action = lights_commands.L39C_Command_FwdLightsReostat, name = _('Instrument Lights Intensity Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.LIGHTS, action = lights_commands.L39C_Command_AftLightsReostat, name = _('Instrument Lights Intensity Knob (Custom, Rear Cockpit)')},

		{cockpit_device_id = devices.LIGHTS, action = lights_commands.L39C_Command_WarningLightIntensityFwd, name = _('Warning-Light Intensity Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.LIGHTS, action = lights_commands.L39C_Command_WarningLightIntensityAft, name = _('Warning-Light Intensity Knob (Custom, Rear Cockpit)')},

		{cockpit_device_id = devices.OXYGEN, action = oxygen_commands.L39C_Command_FwdOxygenSupplyValve, name = _('Oxygen Supply Valve (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.OXYGEN, action = oxygen_commands.L39C_Command_AftOxygenSupplyValve, name = _('Oxygen Supply Valve (Custom, Rear Cockpit)')},

		-- {cockpit_device_id = devices.AIR_INTERFACE, action = device_commands.Button_13, name = _('Helmet Heating Temperature Rheostat (Custom)')},

		{cockpit_device_id = devices.SPU_9, action = spu_commands.CMD_SPU9_FWD_RST_INT_VOLUME, name = _('Intercom Volume Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.SPU_9, action = spu_commands.CMD_SPU9_FWD_RST_RADIO_VOLUME, name = _('Intercom Volume Knob (Custom, Rear Cockpit)')},

		{cockpit_device_id = devices.SPU_9, action = spu_commands.CMD_SPU9_AFT_RST_INT_VOLUME, name = _('Radio Volume Knob (Custom, Front Cockpit)')},
		{cockpit_device_id = devices.SPU_9, action = spu_commands.CMD_SPU9_AFT_RST_RADIO_VOLUME, name = _('Radio Volume Knob (Custom, Rear Cockpit)')},
	}
}