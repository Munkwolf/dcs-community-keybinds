return {
	...
	axisCommands = {
		{cockpit_device_id = devices.GENERAL, action = device_commands.Air_condition_lever, name = _('Air Conditioning')},
		{cockpit_device_id = devices.PITOT, action = device_commands.Barometric_pressure_mouse, name = _('Barometric Pressure')},
		{cockpit_device_id = devices.RADIO, action = device_commands.Radio_Volume, name = _('Radio Volume')},
	}
}