...
-- {down = devCmds.Cmd683, cockpit_device_id  = devices.MAIN, value_down = -1.0, name = _('Lights test and brightness selector - Counterclockwise'), category = {_('Right console'), _('Inertial navigation system')}},
	...
	axisCommands = {
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd459, name = _('UHF radio function selector')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd680, name = _('INS Parameters selector')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd681, name = _('INS Modes selector')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd682, name = _('INS Waypoints selecting wheel')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd683, name = _('INS Lights test and brightness selector')},
	}
}