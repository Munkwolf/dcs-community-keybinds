return {
	...
	axisCommands = {
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd657, name = _('Navigation Mode selector switch')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd667, name = _('Aerial refuelling light adjustment potentiometer')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd675, name = _('ALR-300 display brightness')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd292, name = _('Jammer detection / Feeder tanks overflow light')},
	}
}