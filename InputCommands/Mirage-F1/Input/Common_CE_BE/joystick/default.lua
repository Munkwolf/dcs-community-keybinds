...
-- {down = devCmds.Cmd577, up = devCmds.Cmd577, cockpit_device_id = devices.MAIN ,value_down = -1.0, value_up = 0.0, name = _('Radar detector indicator test switch - CW'), category = {_('Central front panel'), _('Radar detector')}},
	...
	axisCommands = {
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd555, name = _('Navigation Mode selector switch')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd557, name = _('Normal/Additional vector selector switch')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd559, name = _('Bearing/Distance selector knob')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd292, name = _('Jammer detection light')},
	}
}