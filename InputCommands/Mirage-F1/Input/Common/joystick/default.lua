return {
	...
	axisCommands = {
		...
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd102, name = _('Radar control stick scan selection')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd120, name = _('Slat/Flap lever')},
		...
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd199, name = _('Emergency U/C handle')},
