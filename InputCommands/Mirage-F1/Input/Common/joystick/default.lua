return {
	keyCommands = {
		...
		{cockpit_device_id = devices.MAIN, pressed = devCmds.Cmd129, value_pressed = -0.5,  name=_('VOR potentiometer - Decrease (Slow)'), category = {_('Left console'), _('Radio system'), _('Radio selector unit'), _('Custom')}},
		{cockpit_device_id = devices.MAIN, pressed = devCmds.Cmd129, value_pressed = 0.5,  name=_('VOR potentiometer - Increase (Slow)'), category = {_('Left console'), _('Radio system'), _('Radio selector unit'), _('Custom')}},
		{cockpit_device_id = devices.MAIN, pressed = devCmds.Cmd129, value_pressed = -2,  name=_('VOR potentiometer - Decrease (Fast)'), category = {_('Left console'), _('Radio system'), _('Radio selector unit'), _('Custom')}},
		{cockpit_device_id = devices.MAIN, pressed = devCmds.Cmd129, value_pressed = 2,  name=_('VOR potentiometer - Increase (Fast)'), category = {_('Left console'), _('Radio system'), _('Radio selector unit'), _('Custom')}},
...
-- {down = devCmds.Cmd380, up = devCmds.Cmd380, cockpit_device_id = devices.MAIN ,value_down = -1.0, value_up = 0.0, name = _('Hot/Cold selector switch - HOT'), category = {_('Right console'), _('Air conditioning system')}},
		...
		{cockpit_device_id = devices.MAIN, down = devCmds.Cmd143, up = devCmds.Cmd143, value_down = -0.1, value_up = 1.1, name = _('Armament master switch guard - CLOSE else OPEN (2-way Switch)'), category = {_('Left console'), _('Armament system'), _('Custom')}},
		{cockpit_device_id = devices.MAIN, down = devCmds.Cmd143, up = devCmds.Cmd143, value_down = 1.1, value_up = -0.1, name = _('Armament master switch guard - OPEN else CLOSE (2-way Switch)'), category = {_('Left console'), _('Armament system'), _('Custom')}},

		{cockpit_device_id = devices.MAIN, down = devCmds.Cmd144, up = devCmds.Cmd144, value_down = 0, value_up = 0.5, name = _('Armament master switch - OFF else ON (2-way Switch)'), category = {_('Left console'), _('Armament system'), _('Custom')}},
		{cockpit_device_id = devices.MAIN, down = devCmds.Cmd144, up = devCmds.Cmd144, value_down = 1, value_up = 0.5, name = _('Armament master switch - TEST else ON (2-way Switch)'), category = {_('Left console'), _('Armament system'), _('Custom')}},
	...
	axisCommands = {
		...
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd128, name = _('VOR potentiometer')},
