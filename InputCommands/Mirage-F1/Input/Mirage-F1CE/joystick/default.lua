return {
	...
	axisCommands = {
		...
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd507, name = _('Radar function selection')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd532, name = _('IFF Function selector switch')},
		{cockpit_device_id = devices.MAIN, action = devCmds.Cmd529, name = _('IFF Mode 4 selector switch')},
	}
}