return {
    keyCommands = {
        ...
        -- RSBN
        {down = device_commands.RSBNmode, up = device_commands.RSBNmode, cockpit_device_id = devices.RSBN, value_down = 1.0, value_up = 0.5, name = _('RSBN Mode: Descend (3-Pos Toggle Switch Up)'), category = _('Avionics')},
        {down = device_commands.RSBNmode, up = device_commands.RSBNmode, cockpit_device_id = devices.RSBN, value_down = 0.0, value_up = 0.5, name = _('RSBN Mode: Landing (3-Pos Toggle Switch Down)'), category = _('Avionics')},

        {down = device_commands.RSBNreset, up = device_commands.RSBNreset, cockpit_device_id = devices.RSBN, value_down = 1.0, value_up = 0.0, name = _('RSBN Reset'), category = _('Avionics')},
        {down = device_commands.RSBNident, up = device_commands.RSBNident, cockpit_device_id = devices.RSBN, value_down = 1.0, value_up = 0.0, name = _('RSBN Identify'), category = _('Avionics')},
        ...
        -- Airbrakes
        {down = device_commands.Airbrakes, up = device_commands.Airbrakes, cockpit_device_id = devices.AIRBRAKE, value_down = 1.0, value_up = 0.0, name = _('Airbrakes On (2-Pos Toggle Switch)'), category = _('Flight Controls')},

        -- Flaps
        {down = device_commands.Flaps0, cockpit_device_id = devices.FLAPS, up = device_commands.Flaps25, value_down = 1.0, value_up = 1.0, name = _('Flaps Up (3-Pos Toggle Switch Up)'), category = _('Flight Controls')},
        {down = device_commands.Flaps45, cockpit_device_id = devices.FLAPS, up = device_commands.Flaps25, value_down = 1.0, value_up = 1.0, name = _('Flaps Down (3-Pos Toggle Switch Down)'), category = _('Flight Controls')},

        -- Gears
        {down = device_commands.GearLever, up = device_commands.GearLever, cockpit_device_id = devices.GEARS, value_down = 1.0, value_up = 0.0, name = _('Gears Up (3-Pos Toggle Switch Up)'), category = _('Gears, brakes and chute')},
        {down = device_commands.GearLever, up = device_commands.GearLever, cockpit_device_id = devices.GEARS, value_down = -1.0, value_up = 0.0, name = _('Gears Down (3-Pos Toggle Switch Down)'), category = _('Gears, brakes and chute')},
        {down = device_commands.GearHandleFixator, up = device_commands.GearHandleFixator, cockpit_device_id = devices.GEARS, value_down = 1.0, value_up = 0.0, name = _('Gears Handle Lock released (2-Pos Toggle Switch)'), category = _('Gears, brakes and chute')},

        -- Afterburner
        {down = device_commands.ForsMax, up = device_commands.ForsMax, cockpit_device_id = devices.ENGINE, value_down = 1.0, value_up = 0.0, name = _('Afterburner/Maximum On (2-Pos Toggle Switch)'), category = _('Engine')},
        {down = device_commands.Chr, up = device_commands.Chr, cockpit_device_id = devices.ENGINE, value_down = 1.0, value_up = 0.0, name = _('Emergency Afterburner On (2-Pos Toggle Switch)'), category = _('Engine')},

        -- Air Start
        {down = device_commands.AirStart, up = device_commands.AirStart, cockpit_device_id = devices.ENGINE_START_DEVICE, value_down = 1.0, value_up = 0.0, name = _('Engine Emergency Air Start On (2-Pos Toggle Switch)'), category = _('Engine')},
        ...
        -- Nosegear Brake
        {down = device_commands.NosegearBrake, up = device_commands.NosegearBrake, cockpit_device_id = devices.GEAR_BRAKES, value_down = 1.0, value_up = 0.0, name = _('Nosegear Brake On (2-Pos Toggle Switch)'), category = _('Gears, brakes and chute')},

        -- APU
        {down = device_commands.Zazig, up = device_commands.Zazig, cockpit_device_id = devices.ENGINE_START_DEVICE, value_down = 1.0, value_up = 0.0, name = _('APU On (2-Pos Toggle Switch)'), category = _('Engine')},
        ...
        -- Radar Power
        {down = device_commands.RADARon, up = device_commands.RADARon, cockpit_device_id = devices.RADAR, value_down = 1.0, value_up = 0.5, name = _('Radar On (3-Pos Toggle Switch Up)'), category = _('Radar and SPO')},
        {down = device_commands.RADARon, up = device_commands.RADARon, cockpit_device_id = devices.RADAR, value_down = 0.0, value_up = 0.5, name = _('Radar Off (3-Pos Toggle Switch Down)'), category = _('Radar and SPO')},

        -- Radar Low Altitude Filter
        {down = device_commands.RADARlowAlt, up = device_commands.RADARlowAlt, cockpit_device_id = devices.RADAR, value_down = 1, value_up = 0.5, name = _('Low Altitude Antenna Tilt (3-Pos Toggle Switch Up)'), category = _('Radar and SPO')},
        {down = device_commands.RADARlowAlt, up = device_commands.RADARlowAlt, cockpit_device_id = devices.RADAR, value_down = 0.0, value_up = 0.5, name = _('Low Altitude Filter Off (3-Pos Toggle Switch Down)'), category = _('Radar and SPO')},
        ...
        --Weapon Master Mode
        {down = device_commands.ASPvozduhZemlja, up = device_commands.ASPvozduhZemlja, cockpit_device_id = devices.WEAPON_CONTROL, value_down = 1.0, value_up = 0.0, name = _('Master Mode - Air/Gnd (2-Pos Toggle Switch)'), category = _('Weapons / Master control')},
        {down = device_commands.ASPssNeutrRns, up = device_commands.ASPssNeutrRns, cockpit_device_id = devices.WEAPON_CONTROL, value_down = 1.0, value_up = 0.5, name = _('Weapon AA Mode - IR Missile (3-Pos Toggle Switch Up)'), category = _('Weapons / Master control')},
        {down = device_commands.ASPssNeutrRns, up = device_commands.ASPssNeutrRns, cockpit_device_id = devices.WEAPON_CONTROL, value_down = 0.0, value_up = 0.5, name = _('Weapon AA Mode - SAR Missile (3-Pos Toggle Switch Down)'), category = _('Weapons / Master control')},
        {down = device_commands.ASPssNeutrRns, up = device_commands.ASPssNeutrRns, cockpit_device_id = devices.WEAPON_CONTROL, value_down = 1.0, value_up = 0.0, name = _('Weapon AA Mode - IR Missile (2-Pos Toggle Switch)'), category = _('Weapons / Master control')},
