return {
	...
	axisCommands = {
		{cockpit_device_id = 0, action = 3130, name = _('ALR-67 AUDIO Control Knob (no function)')},
		{cockpit_device_id = devices.RWR, action = rwr_commands.DisType, name = _('ALR-67 DIS TYPE Switch, N/I/A/U/F')},
		{cockpit_device_id = devices.SMS, action = SMS_commands.SelJettLvr, name = _('Selective Jettison Knob')},
		{cockpit_device_id = devices.INTERCOM, action = intercom_commands.ILS_ChannelSelector, name = _('ILS Channel Selector Switch')},
		{cockpit_device_id = devices.RWR, action = rwr_commands.DisType, name = _('ALR-67 DIS TYPE Switch')},
		{cockpit_device_id = devices.ASPJ, action = ASPJ_commands.ASPJ_SwitchChange, name = _('ECM Mode Switch')},
	}
}
