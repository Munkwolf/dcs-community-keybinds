return {
	keyCommands = {
		...
		{cockpit_device_id = devices.CONTROL_INTERFACE, down = control_commands.AB_DETENT, up = control_commands.AB_DETENT, value_down = 1, value_up = 1, name = _('Cycle Afterburner Detent - ON/OFF (2-way Switch)'), category = {_('Throttle Quadrant'), _('Custom')}},		
		...
		{cockpit_device_id = devices.CPTLIGHTS_SYSTEM, pressed = cptlights_commands.IndBrtAoA_ITER, value_pressed = -0.15, name = _('AOA Indexer Dimming Lever - CCW/Decrease (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CPTLIGHTS_SYSTEM, pressed = cptlights_commands.IndBrtAoA_ITER, value_pressed = 0.15, name = _('AOA Indexer Dimming Lever - CW/Increase (Slow)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CPTLIGHTS_SYSTEM, pressed = cptlights_commands.IndBrtAoA_ITER, value_pressed = -0.6, name = _('AOA Indexer Dimming Lever - CCW/Decrease (Fast)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CPTLIGHTS_SYSTEM, pressed = cptlights_commands.IndBrtAoA_ITER, value_pressed = 0.6, name = _('AOA Indexer Dimming Lever - CW/Increase (Fast)'), category = {_('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CPTLIGHTS_SYSTEM, down = cptlights_commands.IndBrtAoA, up = cptlights_commands.IndBrtAoA, value_down = 0, value_up = 1, name = _('AOA Indexer Dimming Lever - 0% else 100% (2-way Switch)'), category = {_('Special For Joystick'), _('Instrument Panel'), _('Custom')}},
		{cockpit_device_id = devices.CPTLIGHTS_SYSTEM, down = cptlights_commands.IndBrtAoA, up = cptlights_commands.IndBrtAoA, value_down = 1, value_up = 0, name = _('AOA Indexer Dimming Lever - 100% else 0% (2-way Switch)'), category = {_('Special For Joystick'), _('Instrument Panel'), _('Custom')}},
	...
	axisCommands = {
		...
		{cockpit_device_id = devices.EXTLIGHTS_SYSTEM, action = extlights_commands.Master, name = _('MASTER Switch, OFF/ALL/A-C/FORM/NORM')},
		{cockpit_device_id = devices.FUEL_INTERFACE, action = fuel_commands.EngineFeedSw, name = _('ENGINE FEED Knob, OFF/NORM/AFT/FWD')},
		{cockpit_device_id = devices.ECS_INTERFACE, action = ecs_commands.AirSourceKnob, name = _('AIR SOURCE Knob, OFF/NORM/DUMP/RAM')},
		{cockpit_device_id = devices.INS, action = ins_commands.ModeKnob, name = _('INS Knob, OFF/STOR HDG/NORM/NAV/CAL/INFLT ALIGN/ATT')},
		{cockpit_device_id = devices.INTERCOM, action = intercom_commands.COM1_ModeKnob, name = _('COMM 1 (UHF) Mode Knob')},
		{cockpit_device_id = devices.INTERCOM, action = intercom_commands.COM2_ModeKnob, name = _('COMM 2 (VHF) Mode Knob')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.ChannelKnob, name = _('UHF CHAN Knob')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.FreqSelector100Mhz, name = _('UHF Manual Frequency Knob 100 MHz')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.FreqSelector10Mhz, name = _('UHF Manual Frequency Knob 10 MHz')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.FreqSelector1Mhz, name = _('UHF Manual Frequency Knob 1 MHz')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.FreqSelector01Mhz, name = _('UHF Manual Frequency Knob 0.1 MHz')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.FreqSelector0025Mhz, name = _('UHF Manual Frequency Knob 0.025 MHz')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.FunctionKnob, name = _('UHF Function Knob')},
		{cockpit_device_id = devices.UHF_CONTROL_PANEL, action = uhf_commands.FreqModeKnob, name = _('UHF Mode Knob')},
		{cockpit_device_id = devices.IFF_CONTROL_PANEL, action = iff_commands.MasterKnob, name = _('IFF MASTER Knob, OFF/STBY/LOW/NORM/EMER')},
		{cockpit_device_id = devices.KY58, action = ky58_commands.KY58_ModeSw, name = _('KY-58 MODE Knob, P/C/LD/RV')},
		{cockpit_device_id = devices.KY58, action = ky58_commands.KY58_FillSw, name = _('KY-58 FILL Knob, Z 1-5/1/2/3/4/5/6/Z ALL')},
		{cockpit_device_id = devices.KY58, action = ky58_commands.KY58_PowerSw, name = _('KY-58 Power Knob, OFF/ON/TD')},
		{cockpit_device_id = devices.CMDS, action = cmds_commands.Prgm, name = _('PROGRAM Knob, BIT/1/2/3/4')},
		{cockpit_device_id = devices.CMDS, action = cmds_commands.Mode, name = _('MODE Knob, OFF/STBY/MAN/SEMI/AUTO/BYP')},
	}
}